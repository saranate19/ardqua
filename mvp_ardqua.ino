...
void loop()
{
  ...
  if (now - lastSampleTs >= SAMPLE_INTERVAL_MS)
  {
    ...
    {
    case 1:
      threshold = THRESH_WET;
      pumpTime = PUMP_WET_MS;
      break;
    case 2:
      threshold = THRESH_NORMAL;
      pumpTime = PUMP_NORMAL_MS;
      break;
    case 3:
      threshold = THRESH_DRY;
      pumpTime = PUMP_DRY_MS;
      break;
    default:
      threshold = THRESH_NORMAL;
      pumpTime = DEFAULT_PUMP_TIME;
    }
